...
- **Import GPX**: tombol "Impor" membaca file `.gpx` (track/route/waypoint, maks 10 MB) dan **langsung memakai jalurnya apa adanya** — geometri asli utuh, tanpa snap, tanpa dialog konfirmasi. Peta otomatis pas-fit ke lintasan; statistik & PDF tetap terhitung.
